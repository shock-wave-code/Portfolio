...
const Navbar = () => {
  ...
  return (
    <div className=" text-white/70 pt-6 flex items-center justify-center">
        <div className="hidden md:flex items-center px-4 py-2 mx-auto mx-w-[400px]">
        ...
        <div onClick={toggleNav} className="md:hidden absolute top-5 rigth-5 border rounded text-white/70 border-white/70 p-2 z-50 ">
        ...
        <motion.div
            ...
            className="fixed left-0 top-0 w-full z-50 bg-black/90"
        >
